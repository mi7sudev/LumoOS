...
const ROOT = path.resolve(process.env.LUMO_DIST_DIR || 'D:/ProtoLumo/WebClients/applications/lumo/dist');
const DATA_DIR = path.resolve(process.env.LUMO_DATA_DIR || 'D:/ProtoLumo/data');
